...
export default function SetupPinScreen() {
    ...
    const handlePinChange = (index: number, value: string, isConfirm = false) => {
        ...
        if (isConfirm) {
            ...
            if (index === 5 && newConfirmPin.every(digit => digit !== "")) {
                setTimeout(() => {
                    handleSubmit();
                }, 500);
            }
            ...
            <View style={styles.container}>
                            ...
                            {[0, 1, 2, 3, 4, 5].map((index) => (
                                <TextInput
                                    ...
                                    style={[
                                        ...
                                        pin.join('') === confirmPin.join('') && confirmPin[index] && styles.pinInputMatched
                                    ]}
                                    value={showConfirmPin ? confirmPin[index] : confirmPin[index] ? "•" : ""}
                ...
                <TouchableOpacity
                    style={[
                        ...
                        (pin.join('').length !== 6 || confirmPin.join('').length !== 6) && styles.buttonDisabled
                    ]}
